...
const getSkillIcon = (skillName) => {
  ...
  const iconMap = {
    "React": <div className="w-6 h-6 text-cyan-400">⚛️</div>,
    ...
    "CSS": <Palette className="w-6 h-6 text-blue-400" />,
    "Git": <Github className="w-6 h-6 text-gray-400" />,
    "MongoDB": <Database className="w-6 h-6 text-green-600" />,
    "SQL": <Database className="w-6 h-6 text-blue-600" />
  };
